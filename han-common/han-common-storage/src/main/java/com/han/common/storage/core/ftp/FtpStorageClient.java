package com.han.common.storage.core.ftp;
 ...
 */
public class FtpStorageClient extends AbstractStorageClient<FtpStorageClientConfig> {
    ...
    public FtpStorageClient(Long id, FtpStorageClientConfig config) {
        super(id, config);
    }

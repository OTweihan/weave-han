package com.han.common.storage.core.sftp;
 ...
 */
public class SftpStorageClient extends AbstractStorageClient<SftpStorageClientConfig> {
    ...
    public SftpStorageClient(Long id, SftpStorageClientConfig config) {
        super(id, config);
    }

...
CREATE TABLE blog_visit (
    ...
    referer      VARCHAR(255)   NULL     DEFAULT NULL   COMMENT '来源页（适当放宽长度）',
    visit_time   DATETIME       NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '访问时间',
    PRIMARY KEY (visit_id),
    INDEX idx_post_time(post_id, visit_time DESC), 
    INDEX idx_time(visit_time DESC),
    INDEX idx_ip_post_time(ip_address, post_id, visit_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='博客访问记录表' ROW_FORMAT=DYNAMIC;
